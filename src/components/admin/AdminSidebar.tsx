import { LayoutDashboard, Users, FileText, Settings, ArrowLeft, DollarSign, Palette, MessageSquareQuote, HelpCircle, Paintbrush } from "lucide-react";
...
const adminNavItems = [
  ...
  { title: "Themes", url: "/admin/themes", icon: Paintbrush },
