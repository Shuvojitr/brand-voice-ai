import { LayoutDashboard, FileText, ArrowLeft, MessageSquareQuote, HelpCircle, FileStack, BarChart3, Home } from "lucide-react";
...
const managerNavItems = [
  ...
  { title: "Homepage", url: "/manager/homepage", icon: Home },
