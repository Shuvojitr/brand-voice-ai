...
import { Ticket, Search, Filter, Eye, Clock, CheckCircle, AlertCircle, MessageSquare } from "lucide-react";
              ...
              <>
                ...
                <Tabs defaultValue="conversation" className="flex-1 flex flex-col overflow-hidden">
                  ...
                  <TabsContent value="details" className="space-y-6 mt-4 overflow-y-auto max-h-[50vh]">
                    ...
                    <div>
                      <label className="text-sm font-medium text-muted-foreground mb-2 block">Internal Notes</label>
                      <Textarea
                        value={adminNotes}
